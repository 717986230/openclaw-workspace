...
### 核心功能
- ✅ **双脑架构** - SQLite（结构化）+ LanceDB（向量）
- ✅ **四层记忆栈** - 工作记忆、情景记忆、语义记忆、程序记忆
- ✅ **四策略检索** - 按需归因、时间衰减、重要性优先、向量语义
- ✅ **Theory of Mind** - 心智模型推理引擎
- ✅ **情感分析** - EQ改进，7种情绪类型
- ✅ **增强检索** - 关键词提取、相关记忆检测
- ✅ **Ollama集成** - 本地模型嵌入（可选）
...
- ✅ **Compiled Truth + Timeline** - 编译真理+时间线
- ✅ **Dream Cycle** - 夜间自动维护
...
- ✅ **多平台接入层** - Feishu、Telegram、Discord等
- ✅ **分层上下文** - 5层上下文管理
- ✅ **自进化系统** - 自动学习和改进
- ✅ **工具注册** - 工具能力管理
- ✅ **互联网获取** - Agent-Reach集成
- ✅ **安全扫描** - CyberMind/HexMind集成（可选）
